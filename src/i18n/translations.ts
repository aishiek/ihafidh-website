...
export const translations: Record<Language, TranslationKeys> = {
    ...
    ta: {
        ...
        // Hero
        ramadanText: 'இந்த ரமலான், ஒவ்வொரு நாளும் இரவும் பயனுள்ளதாக மாற்றுங்கள். மனப்பாடம் செய்யுங்கள், ஓதுங்கள், சிந்தியுங்கள்.',
        versionBadge: 'புதிய பதிப்பு 2.0.6 வெளியானது',
        heroHeadline: 'குர்ஆன் மனப்பாடத்தில் தொடர்ச்சியாக இருக்க சிரமப்படுகிறீர்களா?',
        heroHeadlineHighlight: '',
        heroSubheadline: '30 நாட்களில் 0 முதல் 1 ஜுஸ் வரை. உங்கள் முன்னேற்றத்தைக் கண்காணியுங்கள், நிலைத்தன்மையை உருவாக்குங்கள், உங்கள் ஹிஃப்ழ் இலக்குகளை அடையுங்கள்.',
        appStoreRating: 'App Store-இல் 4.8 மதிப்பீடு',
        joinCommunity: 'உலகெங்கிலும் உள்ள ஆயிரக்கணக்கான முஸ்லிம்களுடன் இணையுங்கள்',
        ctaFree: 'இலவசம், இப்போதே தொடங்குங்கள்',
        ...
        step4Desc: 'விரிவான புள்ளிவிவரங்களைப் பயன்படுத்தி முறைகளை அடையாளம் கண்டு, இடைவெளி மீள்நினைவு முறையைப் பயன்படுத்தி நிலைத்தன்மையாக இருங்கள்.',

        // Features
        featuresTitle: 'ஒவ்வொரு ஹாஃபிழுக்கும் சக்திவாய்ந்த அம்சங்கள்',
        featuresSubtitle: 'நிலைத்தன்மையாக இருக்கவும் உங்கள் மனப்பாட இலக்குகளை அடையவும் தேவையான அனைத்தும்.',
        feature1Title: 'தனிப்பயன் பக்க முறை',
        ...
        feature2Desc: 'காட்சி முன்னேற்ற குறிகாட்டிகளுடன் அனைத்து 114 சூராக்கள் மற்றும் 30 ஜுஸ்களிலும் உங்கள் பயணத்தைக் கண்காணிக்கவும்.',
        feature3Title: 'மேம்பட்ட பகுப்பாய்வு',
        feature3Desc: 'உங்கள் தினசரி முயற்சிகளை காட்சிப்படுத்த விரிவான மனப்பாட புள்ளிவிவரங்கள் மற்றும் செயல்திறன் அளவீடுகள்.',
        feature4Title: 'இடைவெளி மீள்நினைவு',
        feature4Desc: 'சிறந்த தக்கவைப்பு மற்றும் நீண்டகால மனப்பாடத்திற்காக வடிவமைக்கப்பட்ட புத்திசாலி மறுபரிசீலனை அமைப்பு.',
        feature5Title: 'ஆடியோ ஓதுதல்கள்',
        feature5Desc: 'தனிப்பயனாக்கக்கூடிய ஆடியோ கட்டுப்பாடுகளுடன் தரமான ஆயத்து வாரியான பயிற்சி.',
        feature6Title: 'படிப்பு திட்டங்கள்',
        feature6Desc: 'தனிப்பயனாக்கக்கூடிய படிப்பு திட்டங்களை உருவாக்கி, உங்களை சரியான பாதையில் வைத்திருக்க புத்திசாலி நினைவூட்டல்களைப் பெறுங்கள்.',

        // Stats
        statsTitle: 'உங்கள் வெற்றியைக் காட்சிப்படுத்துங்கள்',
        statsDesc: 'அளவிடப்படுவது நிர்வகிக்கப்படும் என்று கூறுவார்கள். iHafidh உங்கள் முன்னேற்றத்தில் ஆழமான நுண்ணறிவுகளை வழங்குகிறது, முறைகளை அடையாளம் காணவும் ஊக்கமாக இருக்கவும் உதவுகிறது.',
        statsList1: 'தினசரி & வாராந்திர செயல்பாட்டு வெப்ப வரைபடங்கள்',
        ...
        dailyDesc: 'நீங்கள் ஹிஃப்ழை நோக்குகிறீர்களா அல்லது அர்த்தமுள்ள தினசரி ஓதுதலை விரும்புகிறீர்களா என்றாலும், iHafidh ஒவ்வொரு முஸ்லிமுக்கும் உயர்தர வாசிப்பு அனுபவத்தை வழங்குகிறது.',
        dailyFeature1Title: 'தினசரி ஆயத் அறிவிப்புகள்',
        dailyFeature1Desc: 'உங்கள் காலையை ஒரு அழகான ஆயத்துடனும் சிந்தனையுடனும் தொடங்குங்கள், உங்கள் சாதனத்திற்கு வழங்கப்படும்.',
        ...
        dailyFeature3Desc: 'வாசகத்தில் நேரடியாக பல மொழி தஃப்சீர்களுடன் உங்கள் புரிதலை ஆழப்படுத்துங்கள்.',
        ...
        faq4A: 'நிச்சயமாக. iHafidh சூரா நிலை (அனைத்து 114) மற்றும் ஜுஸ் நிலை (அனைத்து 30) இரண்டிலும் ஒரே நேரத்தில் உங்கள் முன்னேற்றத்தைக் கண்காணிக்க அனுமதிக்கிறது.',

        // Latest Updates
        updatesTitle: 'சமீபத்திய புதுப்பிப்புகள் (v2.0.6)',
        update1Title: 'முஸ்ஹஃப் ஆடியோ மீண்டும் இயக்கம்',
        update1Desc: 'திறமையான ஹிஃப்ழ் மீண்டும் இயக்கத்திற்கு ஆயத்து அல்லது பக்க அளவில் ஆடியோவை மீண்டும் இயக்குங்கள்.',
        ...
        update4Title: 'தனிப்பயன் பக்க முறை',
        update4Desc: 'ஒரு பக்கத்திற்கு 3 முதல் 20 ஆயத்துக்கள் வரை உங்கள் வாசிப்பு அனுபவத்தைத் தனிப்பயனாக்குங்கள்.',

        // Testimonials
        testimonialsTitle: 'உம்மத்தால் விரும்பப்படுகிறது',
        testimonialsSubtitle: 'உலகெங்கிலும் உள்ள அர்ப்பணிப்புள்ள ஹுஃப்பாழ்களின் எங்கள் வளர்ந்து வரும் சமூகத்தில் இணையுங்கள்.',

        // CTA
        ctaTitle: 'இப்போதே உங்கள் ஹிஃப்ழ் பயணத்தைத் தொடங்குங்கள்',
        ctaDesc: 'புனித குர்ஆனை கற்க iHafidh-ஐப் பயன்படுத்தும் உலகெங்கிலும் உள்ள ஆயிரக்கணக்கான முஸ்லிம்களுடன் இணையுங்கள்.',
