...
export const translations: Record<Language, TranslationKeys> = {
    en: {
        ...
        versionBadge: 'v2.1.1',
        heroHeadline: 'Recite with AI.',
        heroHeadlineHighlight: 'Perfect Every Word.',
        heroHeadlineTafsir: 'Recite with AI.',
        heroHeadlineTafsirHighlight: 'Perfect Every Word.',
        heroSubheadline: 'The ultimate tool for Reciters and the Memorizing crowd. iHafidh now brings you Intelligent AI Quiz to precisely evaluate your recitation with a word-by-word percentage scorecard.',
    ...
    ta: {
        ...
        versionBadge: 'v2.1.1',
        heroHeadline: 'AI உடன் ஓதுங்கள்.',
        heroHeadlineHighlight: 'ஒவ்வொரு வார்த்தையையும் சரியாக்குங்கள்.',
        heroHeadlineTafsir: 'AI உடன் ஓதுங்கள்.',
        heroHeadlineTafsirHighlight: 'ஒவ்வொரு வார்த்தையையும் சரியாக்குங்கள்.',
        heroSubheadline: 'உங்கள் மனப்பாடத்தை AI உதவியுடன் மிகவும் துல்லியமாக மதிப்பீடு செய்யுங்கள்.',
        availabilityText: 'Word by Word Translations is available in English, Malay, Tamil and Urdu',
    ...
    ms: {
        ...
        versionBadge: 'v2.1.1',
        heroHeadline: 'Baca dengan AI.',
        heroHeadlineHighlight: 'Sempurnakan Setiap Perkataan.',
        heroHeadlineTafsir: 'Baca dengan AI.',
        heroHeadlineTafsirHighlight: 'Sempurnakan Setiap Perkataan.',
        heroSubheadline: 'Uji hafazan anda secara terperinci dengan Kuiz AI yang baharu.',
        availabilityText: 'Word by Word Translations is available in English, Malay, Tamil and Urdu',
    ...
    ur: {
        ...
        versionBadge: 'v2.1.1',
        heroHeadline: 'AI کے ساتھ تلاوت کریں.',
        heroHeadlineHighlight: 'ہر لفظ کو پرفیکٹ بنائیں۔',
        heroHeadlineTafsir: 'AI کے ساتھ تلاوت کریں.',
        heroHeadlineTafsirHighlight: 'ہر لفظ کو پرفیکٹ بنائیں۔',
        heroSubheadline: 'اپنے حفظ کو درستگی کے ساتھ جانچیں۔',
        availabilityText: 'Word by Word Translations is available in English, Malay, Tamil and Urdu',
