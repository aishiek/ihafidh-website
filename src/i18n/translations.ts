...
export const translations: Record<Language, TranslationKeys> = {
    ...
    ta: {
        ...
        heroSubheadline: 'உங்கள் பாதையைத் தேர்வுசெய்யுங்கள்: 30 நாட்களில் உங்கள் முதல் ஜுஸை மனப்பாடம் செய்யுங்கள் அல்லது முழுமையான தஃப்ஸீரை முடியுங்கள். தினசரி முன்னேற்றத்தைக் கண்காணியுங்கள், நிலையான பழக்கங்களை உருவாக்குங்கள், இந்த ரமலானில் குர்ஆனுடனான உங்கள் உறவை மாற்றுங்கள்.',
